...
// contenedorLibros.innerHTML += libro1.getHtmlArticle();


// punto 14
const eliminarArticle = document.querySelectorAll('#libros article');
for (let i = 0; i < eliminarArticle.length; i++) {
    const element = eliminarArticle[i];
    element.remove();
}
